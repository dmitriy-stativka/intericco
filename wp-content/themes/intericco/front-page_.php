...
<section class="middle-wrapper">
  ...
  <div class="info" style="background: url(/wp-content/themes/intericco/images/info-bg.jpg) no-repeat top center; background-size: cover;">
    ...
    <div class="info-middle wow animate__fadeInUp" data-wow-duration="2s">
    ...
    <div class="info-right wow animate__fadeInRight" data-wow-duration="2s">
  ...
  <div class="service">
    ...
    <div class="service-top wow animate__fadeInUp" data-wow-duration="2s">
    ...
    <div class="service-middle">
      ...
      <div class="left-side service-middle-left wow animate__fadeInLeft" data-wow-duration="2s"> 
        ...
        <div class="service-middle-main wow animate__fadeInUp" data-wow-duration="2s">
    ...
    <div class="service-bottom wow animate__fadeInLeft" data-wow-duration="2s"> 
  ...
  <div class="news">
    ...
    <div class="left-side left-side-sm wow animate__fadeInLeft" data-wow-duration="2s"> 
      <div class="left-side-title left-side-sm-title">
        <div class="left-side-title-wrapper left-side-sm-title-wrapper">
    ...
    <div class="news-middle">
      ...
      <div class="news-middle-slider wow animate__fadeInUp" data-wow-duration="2s"> 
        <div class="swiper-container swiper-main">
      ...
      <div class="news-right wow animate__fadeInRight" data-wow-duration="2s"> 
